...
public class Fold {
    ...
    private FoldsInfo.foldType typeOfFold;

    public Fold(int numOfClasses, FoldsInfo.foldType typeOfFold) {
    ...
    public Fold generateSubFold(int numOfSamples, int randomSeed) {
        Fold subFold = new Fold(this.numInstancesPerClass.length, this.typeOfFold);
    ...
    public FoldsInfo.foldType getTypeOfFold() {
        return typeOfFold;
    }
     ...
     * @return
     */
    public boolean isTestFold() { return this.typeOfFold.equals(FoldsInfo.foldType.Test); }
    ...
    public void setIsTestFold(boolean isTest) {
        this.typeOfFold = FoldsInfo.foldType.Test;
    }
     ...
     * @return
     */
    public boolean isTrainFold() { return this.typeOfFold.equals(FoldsInfo.foldType.Train); }

    /**
     * Used to define a fold as train
     * @param isTest
     */
    public void setIsTrainFold(boolean isTest) {
        this.typeOfFold = FoldsInfo.foldType.Train;
    }
     ...
     * @return
     */
    public boolean isValidationFold() { return this.typeOfFold.equals(FoldsInfo.foldType.Validation); }

    /**
     * Used to define a fold as validation
     * @param isTest
     */
    public void setIsValidationFold(boolean isTest) {
        this.typeOfFold = FoldsInfo.foldType.Validation;
    }
