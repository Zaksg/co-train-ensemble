package com.giladkz.verticalEnsemble.StatisticsCalculations;
...
import com.giladkz.verticalEnsemble.Data.DiscreteColumn;
import com.giladkz.verticalEnsemble.Operators.UnaryOperators.EqualRangeDiscretizerUnaryOperator;
import com.giladkz.verticalEnsemble.Operators.UnaryOperators.UnaryOperator;
...
public class StatisticOperations{
    ...
    public long[][] generateDiscreteAttributesCategoryIntersection(DiscreteColumn col1, DiscreteColumn col2) throws Exception {
        ...
        return generateChiSuareIntersectionMatrix(col1Values, col1.getNumOfPossibleValues(),col2Values, col2.getNumOfPossibleValues());
    }

    public long[][] generateChiSuareIntersectionMatrix(int[] col1Values, int col1NumOfValues, int[] col2Values, int col2NumOfValues) {
        long[][] intersectionsMatrix = new long[col1NumOfValues][col2NumOfValues];
